...
public class InstructionsScreens extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            // for mobile
            IMAGE_NAME = new int[]{R.drawable.screen_level1_320, R.drawable.screen_level2_320, R.drawable.screen_level3_320, R.drawable.screen_level4_320};
        }
