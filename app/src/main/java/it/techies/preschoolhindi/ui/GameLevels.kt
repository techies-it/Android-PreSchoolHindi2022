...
import it.techies.preschoolhindi.databinding.ActivityGameLevelsBinding
...
class GameLevels : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.backBT) {
            ...
            val goToLevel1 = Intent(this@GameLevels, Level1::class.java)
            startActivity(goToLevel1)
        } else if (v.id == R.id.btLevel2) {
            // this button take us to game level 2
            val goToLevel1 = Intent(this@GameLevels, Level2::class.java)
            startActivity(goToLevel1)
        } else if (v.id == R.id.btLevel3) {
            // this button take us to game level 3
            val goToLevel1 = Intent(this@GameLevels, Level3::class.java)
            startActivity(goToLevel1)
        } else if (v.id == R.id.btLevel4) {
            // this button take us to game level 4
            val goToLevel1 = Intent(this@GameLevels, Level4::class.java)
            startActivity(goToLevel1)
        }
    }
}